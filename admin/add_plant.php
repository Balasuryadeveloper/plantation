        ...
        <div id="content">
            ...
            <?php 
                ...
                <div class="col-md-6 col-sm-6 mb-2">
                    <label for="count">வாங்கிய மரக்கன்றுகளின் எண்ணிக்கை <span style="color:red">*</span></label>
                <input type="number" name="count" class="form-control" required placeholder="இங்கே உள்ளிடவும்" autocomplete="off" id="count">
                </div>
                <div class="col-md-6 col-sm-6 mb-2">
