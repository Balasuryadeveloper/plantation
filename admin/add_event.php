...
<body>
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <form method='post' action='add_event.php' enctype='multipart/form-data' class="row g-3 shadow-lg">
...
தலைப்பு <span style="color:red">*</span></label>
                ...
                <div class="col-md-6 col-sm-6 mb-2">
                    ...
                    <textarea name="Content" id="" cols="30" rows="7" class="form-control" required placeholder="இங்கே உள்ளிடவும்"></textarea>
                </div>
                <div class="col-md-6 col-sm-6 mb-2">
...
$con=new mysqli('localhost','id18233341_root','t1$ROHySi^^<a7|G','id18233341_vnr');
 if(isset($_POST['submit'])){
  ...
  $date=$_POST['date'];
  // Looping all files
   $sql="INSERT INTO add_event(Title,Content,place,date) VALUES('$Title','$Content','$place','$date')";
