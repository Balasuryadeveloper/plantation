...
<head>
    ...
    <title>மரங்கள் மற்றும் அதன் பயன்கள்</title>
...
<body>
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <form method='post' action='add_tree.php' enctype='multipart/form-data' class="row g-3 shadow-lg">
                <div class="col-md-12 col-sm-12 mb-2">
                    <label for="name">மரத்தின் பெயர் <span style="color:red">*</span></label>
                <input type="text" name="treename" class="form-control" required placeholder="
இங்கே உள்ளிடவும்" autocomplete="off" id="name">
                </div>
                <div class="col-md-12 col-sm-12 mb-2">
                    <label for="Benifits">பயன்கள் <span style="color:red">*</span></label>
                <input type="text" name="benifits" class="form-control" required placeholder="இங்கே உள்ளிடவும்" autocomplete="off" id="benifits">
                </div>
                <div class="col-md-12 col-sm-12 mb-2">
                <label for="Image">புகைப்படம்</label>
                <input type="file" name="photo[]" class="form-control" id="file" accept='.jpg'>
                </div>
                <div class="col-md-12 col-sm-12 mb-2">
...
$con=new mysqli('localhost','id18233341_root','t1$ROHySi^^<a7|G','id18233341_vnr');
 if(isset($_POST['submit'])){
  ...
  for($i=0;$i<$countfiles;$i++){
   ...
   $sql="INSERT INTO tree_details(treename,photo,benifits) VALUES('$treename','$iname1','$benifits')";
   $result=mysqli_query($con,$sql);
      move_uploaded_file($_FILES['photo']['tmp_name'][$i],'../tree_image/'.$iname1);
    //   echo $filename;
    if($result)
    {
